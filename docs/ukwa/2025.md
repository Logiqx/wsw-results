...
A heat will be considered valid for the UKWA windsurf rankings if it meets either of the following criteria:

- At least 25% of the finishing UKWA windsurf adults have achieved 27 kts (or more) at least 2 times
- At least 50% of the finishing UKWA windsurf adults have achieved 25 kts (or more) at least 2 times

Each discipline uses the same principle for assessing the validity, but using different thresholds, listed below.
