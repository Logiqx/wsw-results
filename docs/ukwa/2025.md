...
So that it is viable to compete in multiple disciplines the UKWA will treat each Weymouth Speed Week session as a single leg. This not only makes it feasible to compete in multiple disciplines, but also maximises the chances of each leg being deemed valid.
