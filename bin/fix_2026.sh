fix_all()
{
    sed -i "s/$1/$2/i" events/2026/config/entries.csv
}
...
# Fix name typos
fix_all ",Will Trossell," ",Trossell,"
...
fix_all ",Sav,Salvage," ",Mark,Salvage,"
...
grep 'M[rs][a-z]*,[A-Za-z]*,[A-Za-z]* [A-Za-z]*' events/2026/config/entrants.csv
